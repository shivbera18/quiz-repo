...
export function QuizFilters({ onFilterChange, activeFilters }: QuizFiltersProps) {
    ...
    return (
        <Sheet open={isOpen} onOpenChange={setIsOpen}>
            ...
            <SheetContent className="border-l-4 border-black dark:border-white/60">
                <SheetHeader>
                ...
                <div className="grid gap-6 py-6">
                    ...
                    <div className="space-y-4">
                        <div className="flex justify-between">
                            ...
                            <span className="text-sm font-bold bg-blue-200 dark:bg-blue-400/30 px-2 py-0.5 rounded border-2 border-black dark:border-white/60">{localFilters.duration[1]}m</span>
                        </div>
                        <Slider
                            defaultValue={[120]}
