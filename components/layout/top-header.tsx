...
function AnnouncementContent({ 
  ...
  return (
    <>
      <div className="flex items-center justify-between p-4 border-b-2 border-black dark:border-white/65">
...
export function TopHeader() {
  ...
  return (
    <>
        ...
        {isVisible && (
          ...
          >
            <Popover open={isOpen} onOpenChange={setIsOpen}>
              ...
              <PopoverContent
                className="w-[calc(100vw-2rem)] max-w-96 p-0 border-2 border-black dark:border-white/65 shadow-[4px_4px_0px_0px_#000] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.65)] rounded-lg mr-2"
                align="end"
                sideOffset={8}
              >
                <AnnouncementContent 
      ...
      <div 
        className={cn(
          "hidden md:flex items-center justify-end gap-3 px-4 py-3 bg-background border-b-2 border-black dark:border-white/65 sticky top-0 z-30 transition-all duration-300 md:ml-[296px]",
        ...
        <Popover>
          <PopoverTrigger asChild>
            <Button
              variant="outline"
              size="icon"
              className="relative h-10 w-10 rounded-lg border-2 border-black dark:border-white/65 shadow-[3px_3px_0px_0px_#000] dark:shadow-[3px_3px_0px_0px_rgba(255,255,255,0.65)] hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[5px_5px_0px_0px_#000] dark:hover:shadow-[5px_5px_0px_0px_rgba(255,255,255,0.75)] bg-white dark:bg-zinc-900 transition-all"
            >
              <Bell className="h-5 w-5" />
              {unreadCount > 0 && (
          ...
          <PopoverContent
            className="w-80 sm:w-96 p-0 border-2 border-black dark:border-white/65 shadow-[4px_4px_0px_0px_#000] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.65)] rounded-lg"
            align="end"
            sideOffset={8}
          >
            <AnnouncementContent 
