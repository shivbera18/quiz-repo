...
export function TopHeader() {
  ...
  return (
    <>
      ...
      <div 
        className={cn(
          "hidden md:flex items-center justify-end gap-3 px-4 py-3 bg-background border-b-2 border-black dark:border-white/65 sticky top-0 z-50 transition-all duration-300 isolate",
