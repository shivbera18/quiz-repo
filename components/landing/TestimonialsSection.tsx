...
function TestimonialCard({
    ...
    return (
        ...
        >
            <div className="relative rounded-md border-4 border-black bg-card p-8 shadow-[8px_8px_0px_0px_#000] transition-all duration-300 hover:translate-x-[-4px] hover:translate-y-[-4px] hover:shadow-[12px_12px_0px_0px_#000] dark:border-white/50 dark:shadow-[8px_8px_0px_0px_rgba(255,255,255,0.5)] dark:hover:shadow-[12px_12px_0px_0px_rgba(255,255,255,0.6)]">
                <div className="relative z-10">
                    ...
                    <div className="flex items-center gap-3">
                        <div className="h-12 w-12 rounded-md border-4 border-black dark:border-white/50 bg-gradient-to-br from-primary to-purple-600 flex items-center justify-center text-white font-bold text-lg">
                            {initial}
                        </div>
                        <div>
