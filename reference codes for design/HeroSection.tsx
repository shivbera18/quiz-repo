        ...
        <div className="relative flex flex-col items-center justify-center gap-8 py-0 lg:py-10">
          ...
          <div className="flex flex-row gap-3">
            <Link href="/notes">
              <Button
                size="lg"
                className="gap-4 border-2 border-black bg-white text-black shadow-[4px_4px_0px_0px_#000] hover:translate-x-1 hover:translate-y-1 hover:text-white hover:shadow-[2px_2px_0px_0px_#000] dark:border-white/50 dark:bg-zinc-900 dark:text-white dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.45)] dark:hover:shadow-[2px_2px_0px_0px_rgba(255,255,255,0.55)]"
              >
            ...
            <Link href="/premium">
              <Button
                size="lg"
                className="gap-4 border-2 border-black bg-black text-white shadow-[4px_4px_0px_0px_#000] hover:translate-x-1 hover:translate-y-1 hover:bg-white hover:text-black hover:shadow-[2px_2px_0px_0px_#000] dark:border-white/50 dark:bg-white dark:text-black dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.45)] dark:hover:shadow-[2px_2px_0px_0px_rgba(255,255,255,0.55)]"
              >
                Purchase Premium{" "}
