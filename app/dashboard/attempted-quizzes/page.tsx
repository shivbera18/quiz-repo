      ...
      <div className="container mx-auto px-4 py-4 md:py-8">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center sm:justify-between gap-4 mb-8">
          <div className="flex items-center gap-4">
            <Link href="/dashboard">
              <Button variant="outline" size="icon" className="rounded-lg h-11 w-11 border-2 border-black dark:border-white/60 shadow-[4px_4px_0px_0px_#000] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.6)] hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0px_0px_#000] dark:hover:shadow-[6px_6px_0px_0px_rgba(255,255,255,0.7)] bg-white dark:bg-zinc-900 transition-all">
        ...
        {loadingAttempts ? (
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
              <div className="p-4 rounded-xl bg-card border-2 border-black dark:border-white/60 shadow-[4px_4px_0px_0px_#000] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.6)]">
              ...
              <div className="space-y-3">
                {allAttempts.map((attempt) => {
                  ...
                  return (
                    <div 
                      key={attempt._id} 
                      className="group p-4 rounded-xl bg-card border-2 border-black dark:border-white/60 shadow-[4px_4px_0px_0px_#000] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.6)] hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0px_0px_#000] dark:hover:shadow-[6px_6px_0px_0px_rgba(255,255,255,0.7)] transition-all"
                    >
