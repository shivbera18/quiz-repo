            ...
            <div className="space-y-4">
              {filteredAttempts.map((attempt, index) => {
                ...
                return (
                  <div
                    key={attempt._id}
                    className="flex flex-col sm:flex-row sm:items-center justify-between p-4 border-4 border-black dark:border-white/30 rounded-xl hover:shadow-[4px_4px_0px_0px_#000] dark:hover:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.4)] transition-all gap-4 bg-white dark:bg-zinc-900"
                  >
