        ...
        <div className="flex items-center gap-4">
          <Link href="/dashboard">
            <Button 
              variant="outline" 
              size="icon" 
              className="rounded-lg h-11 w-11 border-2 border-black dark:border-white/60 shadow-[4px_4px_0px_0px_#000] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.6)] hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0px_0px_#000] dark:hover:shadow-[6px_6px_0px_0px_rgba(255,255,255,0.7)] bg-white dark:bg-zinc-900 transition-all"
            >
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 border-2 border-black dark:border-white/60 rounded-lg font-medium"
                />
              </div>
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-4">
              {filteredAttempts.map((attempt, index) => {
                ...
                return (
                  <div
                    key={attempt._id}
                    className="flex flex-col sm:flex-row sm:items-center justify-between p-4 border-4 border-black dark:border-white/60 rounded-xl hover:shadow-[4px_4px_0px_0px_#000] dark:hover:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.7)] transition-all gap-4 bg-white dark:bg-zinc-900"
                  >
