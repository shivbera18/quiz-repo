          ...
          <Card variant="neobrutalist">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex gap-2">                <Button 
                  ...
                  className="border-2 border-black dark:border-white/50 shadow-[2px_2px_0px_0px_#000] dark:shadow-[2px_2px_0px_0px_rgba(255,255,255,0.5)] hover:translate-x-[-1px] hover:translate-y-[-1px] hover:shadow-[3px_3px_0px_0px_#000] dark:hover:shadow-[3px_3px_0px_0px_rgba(255,255,255,0.6)] transition-all"
                >
                  Clear Filters
                </Button>
          ...
          <Card variant="neobrutalist" className="mb-6">
            <CardHeader>
              <div className="flex justify-between items-center">
                ...
                <Button variant="ghost" size="icon" onClick={resetForm} className="border-2 border-black dark:border-white/50">
                  <X className="h-4 w-4" />
                </Button>
              </div>
            </CardHeader>
                    ...
                    <div className="flex justify-between items-start">
                      ...
                      <div className="flex gap-1">
                        <Button 
                          ...
                          title="Edit Question"
                          className="border-2 border-black dark:border-white/50"
                        >
                        ...
                        <Button 
                          ...
                          className="border-2 border-black dark:border-white/50 text-red-500"
                        >
                    ...
                    <div className="space-y-3">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                        {question.options.map((option, optIndex) => (
                          <div 
                            key={optIndex} 
                            className={`p-2 rounded-lg border-2 border-black dark:border-white/50 ${
              ...
              {totalPages > 1 && (
                <div className="flex justify-center gap-2 mt-6">
                  <Button
                    ...
                    className="border-2 border-black dark:border-white/50 shadow-[2px_2px_0px_0px_#000] dark:shadow-[2px_2px_0px_0px_rgba(255,255,255,0.5)] hover:translate-x-[-1px] hover:translate-y-[-1px] hover:shadow-[3px_3px_0px_0px_#000] dark:hover:shadow-[3px_3px_0px_0px_rgba(255,255,255,0.6)] transition-all disabled:opacity-50"
                  >
                    Previous
                  </Button>
                    ...
                    {Array.from({ length: Math.min(5, totalPages) }, (_, i) => {
                      ...
                      return (
                        <Button
                          ...
                          className={currentPage !== pageNum ? "border-2 border-black dark:border-white/50 shadow-[2px_2px_0px_0px_#000] dark:shadow-[2px_2px_0px_0px_rgba(255,255,255,0.5)]" : ""}
                        >
                          {pageNum}
                        </Button>
                      )
