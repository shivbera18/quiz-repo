            ...
            {quiz.questions.length === 0 ? (
              ...
              <div className="space-y-4">
                {quiz.questions.map((question, index) => (
                  <div key={question.id} className="border-2 border-black dark:border-white rounded-lg p-4 shadow-[2px_2px_0px_0px_#000] dark:shadow-[2px_2px_0px_0px_rgba(255,255,255,0.3)]">
