            ...
            {quiz.questions.length === 0 ? (
              ...
              <div className="space-y-4">
                {quiz.questions.map((question, index) => (
                  <div key={question.id} className="border-2 border-black dark:border-white/60 rounded-lg p-4 shadow-[2px_2px_0px_0px_#000] dark:shadow-[2px_2px_0px_0px_rgba(255,255,255,0.6)]">
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <div className="flex gap-2 ml-4">
                        <Button variant="ghost" size="icon" onClick={() => handleEditQuestion(question)} className="border-2 border-black dark:border-white/60">
                          <Edit className="h-4 w-4" />
                        </Button>
                        <Button variant="ghost" size="icon" onClick={() => handleDeleteQuestion(question.id)} className="border-2 border-black dark:border-white/60 text-red-500">
