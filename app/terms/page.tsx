...
export default function TermsPage() {
  return (
    <div className="min-h-screen bg-background">
      {/* Header */}
      <header className="sticky top-0 z-50 bg-background/80 backdrop-blur-sm border-b-4 border-foreground">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6">
              <Link href="/terms" className="text-background hover:text-background text-sm font-bold">
                Terms of Service
              </Link>
              <Link href="/privacy" className="text-background/70 hover:text-background text-sm">
                Privacy Policy
              </Link>
            </div>
          </div>
