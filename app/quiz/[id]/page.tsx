...
export default function QuizPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Top Bar */}
      <div className="sticky top-0 z-40 w-full border-b-4 border-black bg-background/95 backdrop-blur dark:border-white/60">
                        ...
                        {quiz.questions.map((q, idx) => {
                          ...
                          return (
                            <button
                              ...
                              className={cn(
                                "relative h-12 w-full rounded-lg border-2 font-bold transition-all flex items-center justify-center shadow-[2px_2px_0px_0px_#000] hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[4px_4px_0px_0px_#000] active:translate-x-[0px] active:translate-y-[0px] active:shadow-[2px_2px_0px_0px_#000] dark:shadow-[2px_2px_0px_0px_rgba(255,255,255,0.6)] dark:hover:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.7)]",
                      ...
                      return (
                        <div
                          ...
                          className={cn(
                            ...
                            isSelected
                              ? "border-black bg-primary/10 shadow-[4px_4px_0px_0px_#000] dark:border-white/60 dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.6)]"
                              : "border-black/20 hover:border-black hover:shadow-[4px_4px_0px_0px_#000] hover:bg-background dark:border-white/60 dark:hover:border-white dark:hover:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.7)]"
                          )}
                        >
                          <div className={cn(
                            "flex h-8 w-8 shrink-0 items-center justify-center rounded-full border-2 transition-colors",
                            isSelected ? "border-black bg-black text-white dark:border-white/60 dark:bg-white dark:text-black" : "border-black/20"
                          )}>
      ...
      {/* Bottom Action Bar */}
      <div className="fixed bottom-0 left-0 right-0 lg:right-80 border-t-4 border-black bg-background/95 backdrop-blur p-3 sm:p-4 z-30 dark:border-white/60">
