                ...
                <header className="flex flex-col lg:flex-row justify-between items-center my-5 px-6 md:px-8 lg:px-12 max-w-[1240px] mx-auto">
                    <div className="flex w-full lg:w-auto items-center justify-between">
                        <Link href="/" className="flex items-center gap-2.5">
                            <svg width="32" height="32" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-black">
                                <path d="M18 0L21.8 14.2L36 18L21.8 21.8L18 36L14.2 21.8L0 18L14.2 14.2L18 0Z" fill="currentColor"/>
                            </svg>
                            <span className="font-medium text-2xl tracking-tight text-black font-grotesk">
                                Positivus
                            </span>
                        </Link>
                    ...
                    <nav className={`${mobileMenuOpen ? "flex" : "hidden"} w-full lg:w-auto mt-2 lg:flex lg:mt-0`}>
                        <ul className="font-medium flex flex-col p-4 lg:p-0 mt-4 border rounded-lg lg:flex-row lg:space-x-8 lg:mt-0 lg:border-0 bg-white w-full lg:w-auto items-center">
                            <li><a href="#about" onClick={() => setMobileMenuOpen(false)} className="block py-2 px-3 text-black rounded lg:bg-transparent lg:p-0">About us</a></li>
                            <li><a href="#services" onClick={() => setMobileMenuOpen(false)} className="block py-2 px-3 text-black rounded lg:bg-transparent lg:p-0">Services</a></li>
                            <li><a href="#use-cases" onClick={() => setMobileMenuOpen(false)} className="block py-2 px-3 text-black rounded lg:bg-transparent lg:p-0">Use Cases</a></li>
                            <li><a href="#process" onClick={() => setMobileMenuOpen(false)} className="block py-2 px-3 text-black rounded lg:bg-transparent lg:p-0">Pricing</a></li>
                            <li><a href="#testimonials" onClick={() => setMobileMenuOpen(false)} className="block py-2 px-3 text-black rounded lg:bg-transparent lg:p-0">Blog</a></li>
