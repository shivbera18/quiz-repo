...
import { scoreQuiz, type ScoringAnswer, type ScoringQuestion } from "@/lib/scoring"
...
// into lib/scoring.ts. Server-side scoring (the new /api/attempts/:id/submit route)
// must reproduce every one of these numbers exactly, including negative marking and
// the totalScore-floors-at-0 behavior.
